...
## THIS FILE IS STILL UNDER CONSTRUCTION. DONOT USE!!
...
# Define the hostname
host1="node5.domain.com"
host2="node6.domain.com"
host3="node7.domain.com"
host4="node8.domain.com"
...
# Node IP names only used in etc_host_update.sh script
ip_host1="10.xxx.xxx.5"
ip_host2="10.xxx.xxx.6"
ip_host3="10.xxx.xxx.7"
ip_host4="10.xxx.xxx.8"
...
# Cloudera Manager Details
d_CM_URL="http://10.xxx.xx.5:<PORT>"
d_CM_USERNAME="admin"
d_CM_PASSWORD="<password>"
# s_ = source cluster
