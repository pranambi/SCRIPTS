...
from cluster_import import start_cluster
...
# Call the start cluster function
start_cluster(d_CM_URL, d_cm_version, d_CM_USERNAME, d_CM_PASSWORD, encoded_d_cluster_name)
